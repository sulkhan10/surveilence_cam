...
class ListOnlineStoreCategory extends Component {
    constructor(props) {
		super(props);
		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'listonlinestorecategory');
        ...
        this.tableColumns = [ {
            ...
            accessor: 'onlinestorecategoryname',
	...
	doRowEdit = (row) => {
        console.log(row);
		this.props.history.push('/panel/editonlinestorecategory/'+row.onlinestorecategoryid);
    }
    ...
    doRowDelete = (row) => {
		...
		confirmAlert({
		  ...
		  buttons: [
			{
				label: 'Yes',
				onClick: (onlinestorecategoryid) => {
					var onlinestorecategoryid = row.onlinestorecategoryid;
					console.log(onlinestorecategoryid);
					this.deleteOnlineStoreCategory(onlinestorecategoryid)					
			  }
			},
			{
			  label: 'No',
	...
	addNew = () => {
		this.props.history.push('/panel/inputonlinestorecategory');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'onlinestorecategory_list.php', {
	...
	deleteOnlineStoreCategory = (onlinestorecategoryid) => {
		this.props.doLoading();
		axios.post(serverUrl+'onlinestorecategory_delete.php', {
            onlinestorecategoryid: onlinestorecategoryid
		}, 
...
export default ListOnlineStoreCategory;
...
class ListRoomReservation extends Component {
    constructor(props) {
		super(props);
		this.reactTable = React.createRef();
		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'listroomreservation');
		this.state = {
			tableData: [],
			filter:'',
	...
	doRowEdit = (row) => {
		this.props.history.push('/panel/editroomreservation/'+row.roomreservationid);
    }
    ...
    doRowDelete = (row) => {
		confirmAlert({
		  ...
		  buttons: [
			{
				label: 'Yes',
				onClick: (roomreservationid) => {
					var roomreservationid = row.roomreservationid;
					this.deleteRoomReservation(roomreservationid)					
			  }
			},
			{
			  label: 'No',
	...
	addNew = () => {
		this.props.history.push('/panel/inputroomreservation');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'roomreservation_list.php', {
	...
	deleteRoomReservation = (roomreservationid) => {
		this.props.doLoading();
		axios.post(serverUrl+'roomreservation_delete.php', {

...
class ListCallCovidCenter extends Component {
    constructor(props) {
		super(props);
	...
	doRowEdit = (row) => {
        console.log(row);
		this.props.history.push('/panel/editcallcovidcenter/'+row.id);
    }
	...
	addNew = () => {
		this.props.history.push('/panel/inputcallcovidcenter');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'callcovidcenter_list.php', {
	...
	deleteCallCenter = (id) => {
		this.props.doLoading();
		axios.post(serverUrl+'callcovidcenter_delete.php', {
            id: id
		}, 
...
export default ListCallCovidCenter;
...
class InputTag extends Component {
  ...
  onSubmit = () => {
    ...
    axios
      .post(
        serverUrl + "tag_insert_update.php",
        {
      ...
      .then((response) => {
        ...
        // this.props.history.push("/panel/listtag");
      })
      .catch((error) => {
        this.props.doLoading();
        console.log(error);
  ...
  renderSuccess = () => {
    if (this.state.openSuccess === true) {
      setTimeout(() => this.props.history.push("/panel/listtag"), 1000);
            ...
            <Alert
              ...
              action={
                <IconButton
                  ...
                  color="inherit"
                  size="small"
                  onClick={() => this.props.history.push("/panel/listtag")}
                >

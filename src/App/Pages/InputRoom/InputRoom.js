...
class InputRoom extends Component {
	...
	changeRoomCategory = (roomcategoryid)=>{
		console.log(this.state.roomcategoryid);
                ...
                <div className="box-container">
					<table>
						<tr>
                            ...
                            <td><Input type="text" name="roomname" id="roomname" placeholder={this.language.fieldname} value={this.state.roomname} onChange = {(event) => this.setState({ roomname : event.target.value }) }/></td>
                        </tr>
						<tr>
						&nbsp;
						</tr>

...
class EditMerchantCategory extends Component {
  constructor(props) {
    super(props);
    this.globallang = getLanguage(activeLanguage, "global");
    this.language = getLanguage(activeLanguage, "editmerchantcategory");
    this.state = {
      merchantcategoryid: props.match.params.merchantcategoryid,
  ...
  componentDidMount = () => {
    ...
    axios
      .post(
        serverUrl + "merchantcategory_get_by_id.php",
        {

...
class ListForWeddingCategory extends Component {
    constructor(props) {
		super(props);
		this.reactTable = React.createRef();
		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'listforweddingcategory');
		...
		this.tableColumns = {
            Header: this.language.columnuse,
			headerStyle: {fontWeight : 'bold'},
            accessor: 'usefor',
            style: { textAlign: "center"}
        },
		this.tableColumns = {
            Header: this.language.columnlocation,
			headerStyle: {fontWeight : 'bold'},
            accessor: 'location',
            style: { textAlign: "center"}
        },		
	...
	doRowEdit = (row) => {
        console.log(row);
		this.props.history.push('/panel/editforweddingcategory/'+row.forweddingcategoryid);
    }
    ...
    doRowDelete = (row) => {
		...
		confirmAlert({
		  ...
		  buttons: [
			{
				label: 'Yes',
				onClick: (forweddingcategoryid) => {
					var forweddingcategoryid = row.forweddingcategoryid;
					console.log(forweddingcategoryid);
					this.deleteRoomCategory(forweddingcategoryid)					
			  }
			},
			{
			  label: 'No',
	...
	addNew = () => {
		this.props.history.push('/panel/inputforweddingcategory');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'forweddingcategory_list.php', {
	...
	deleteRoomCategory = (forweddingcategoryid) => {
		this.props.doLoading();
		axios.post(serverUrl+'forweddingcategory_delete.php', {
            forweddingcategoryid: forweddingcategoryid
		}, 
...
export default ListForWeddingCategory;
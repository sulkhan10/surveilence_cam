...
class ListNewsCategory extends Component {
  constructor(props) {
    super(props);
  ...
  doRowEdit = (row) => {
    console.log(row);
    this.props.history.push("/panel/editnewscategory/" + row.newscategoryid);
  };
  ...
  doRowDelete = (row) => {
    ...
    confirmAlert({
      ...
      buttons: [
        {
          label: "Yes",
          onClick: (newscategoryid) => {
            var newscategoryid = row.newscategoryid;
            console.log(newscategoryid);
            this.deleteNewsCategory(newscategoryid);
          },
        },
        {
          label: "No",
  ...
  addNew = () => {
    this.props.history.push("/panel/inputnewscategory");
  };
  ...
  deleteNewsCategory = (newscategoryid) => {
    ...
    axios
      .post(
        serverUrl + "newscategory_delete.php",
        {

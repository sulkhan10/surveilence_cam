...
class PaymentTransactionMerchantPage extends Component {
  constructor(props) {
    super(props);
  ...
  doSearch = () => {
    ...
    axios
      .post(
        serverUrl + "payment_transaction.php",
        {
  ...
  getListCommunity = (merchantId) => {
    axios
      ...
      .then((response) => {
        ...
        this.selectCommunity(tmp, merchantId);
      })
      .catch((error) => {
        console.log(error);
        alert(error);
  ...
  selectCommunity = (dataCommunity, merchantId) => {
    axios
      .post(
      ...
      .then((response) => {
        ...
        this.loadDataPaymentTransaction(
          getCommunityIdGlobal[0].communityCode,
          merchantId
        );
      })
      .catch((error) => {
  ...
  loadDataPaymentTransaction = (communityCode, merchantId) => {
    this.props.doLoading();
    axios
      .post(
        "http://smart-community.csolusi.com/smartcommunity_webapi_cp/payment_transaction.php",
        {
          filter: "",
        },
      ...
      .then((response) => {
        ...
        const resultTrx = result.filter((elm) => elm.merchantId === merchantId);

        this.setState({ tableData: resultTrx });
      })
      .catch((error) => {
        this.props.doLoading();
        console.log(error);
  ...
  getAdminMerchant = (phone) => {
    axios
      ...
      .then((response) => {
        ...
        this.getListCommunity(tmp.merchantId);
        // this.LoadDataOrder(tmp.merchantId);
      })
      .catch((error) => {
        console.log(error);
        alert(error);
  ...
  reset = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        const resultTrx = result.filter(
          (elm) => elm.merchantId === this.state.merchantid
        );
  ...
  getDataBydate = () => {
    ...
    axios
      .post(
        "http://smart-community.csolusi.com/smartcommunity_webapi_cp/payment_transaction_date.php",
        {
...
export default PaymentTransactionMerchantPage;

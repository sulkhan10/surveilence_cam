...
class PaymentTransactionPage extends Component {
  constructor(props) {
    super(props);
  ...
  selectCommunity = (dataCommunity) => {
    axios
      ...
      .then((response) => {
        ...
        this.loadDataPaymentTransaction(getCommunityIdGlobal[0].communityCode);
      })
      .catch((error) => {
        console.log(error);
        alert(error);
  ...
  loadDataPaymentTransaction = (communityCode) => {
    this.props.doLoading();
    axios
      .post(

...
class EditBusinessCase extends Component {
    constructor(props) {
		super(props);

		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'editbusinesscase');
	...
	componentDidMount = (communityShow) =>{
		...
		axios.post(serverUrl+'businesscase_get_by_id.php', {
            id: this.state.id,
		}, 
...
export default EditBusinessCase;
...
class ListActivityReservation extends Component {
    constructor(props) {
		super(props);
		this.reactTable = React.createRef();
		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'listactivityreservation');
		this.state = {
			tableData: [],
			filter:'',
		...
		{
            Header: this.language.columnactivity,
			headerStyle: {fontWeight : 'bold'},
	...
	doRowEdit = (row) => {
		this.props.history.push('/panel/editactivityreservation/'+row.activityreservationid);
    }
    ...
    doRowDelete = (row) => {
		confirmAlert({
		  ...
		  buttons: [
			{
				label: 'Yes',
				onClick: (activityreservationid) => {
					var activityreservationid = row.activityreservationid;
					this.deleteActivityReservation(activityreservationid)					
			  }
			},
			{
			  label: 'No',
	...
	addNew = () => {
		this.props.history.push('/panel/inputactivityreservation');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'activityreservation_list.php', {
	...
	deleteActivityReservation = (activityreservationid) => {
		this.props.doLoading();
		axios.post(serverUrl+'activityreservation_delete.php', {
...
export default ListActivityReservation;
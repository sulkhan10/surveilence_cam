...
class ListDirectoryCategory extends Component {
  constructor(props) {
    super(props);
    this.reactTable = React.createRef();
    this.globallang = getLanguage(activeLanguage, "global");
    this.language = getLanguage(activeLanguage, "listdirectorycategory");
  ...
  doRowEdit = (row) => {
    ...
    this.props.history.push(
      "/panel/editdirectorycategory/" + row.directorycategoryid
    );
  };
  ...
  doRowDelete = (row) => {
    ...
    confirmAlert({
      ...
      buttons: [
        {
          label: "Yes",
          onClick: (directorycategoryid) => {
            var directorycategoryid = row.directorycategoryid;
            console.log(directorycategoryid);
            this.deleteDirectoryCategory(directorycategoryid);
          },
        },
        {
          label: "No",
  ...
  addNew = () => {
    this.props.history.push("/panel/inputdirectorycategory");
  };
  ...
  deleteDirectoryCategory = (directorycategoryid) => {
    this.props.doLoading();
    axios
      .post(
        serverUrl + "directorycategory_delete.php",
        {
...
export default ListDirectoryCategory;

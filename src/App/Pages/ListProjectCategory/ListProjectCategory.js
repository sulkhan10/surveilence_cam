...
class ListProjectCategory extends Component {
    constructor(props) {
        super(props);
		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'listprojectcategory');
		this.state = {
			tableData: [],
			filter: ''
        }
	...
	doRowEdit = (row) => {
        console.log(row);
		this.props.history.push('/panel/editprojectcategory/'+row.projectcategoryid);
    }
    ...
    doRowDelete = (row) => {
		...
		confirmAlert({
		  ...
		  buttons: [
			{
				label: 'Yes',
				onClick: (projectcategoryid) => {
					var projectcategoryid = row.projectcategoryid;
					console.log(projectcategoryid);
					this.deleteProjectCategory(projectcategoryid)					
			  }
			},
			{
			  label: 'No',
	...
	addNew = () => {
		this.props.history.push('/panel/inputprojectcategory');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'projectcategory_list.php', {
	...
	deleteProjectCategory = (projectcategoryid) => {
		this.props.doLoading();
		axios.post(serverUrl+'projectcategory_delete.php', {

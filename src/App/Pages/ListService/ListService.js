...
class ListService extends Component {
    constructor(props) {
		...
		this.language = getLanguage(activeLanguage, 'listservice');
		this.state = {
			tableData: [],
			filter:'',
	...
	doRowEdit = (row) => {
		this.props.history.push('/panel/editservice/'+row.serviceid);
    }
	...
	addNew = () => {
		this.props.history.push('/panel/inputservice');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'service_list.php', {
	...
	deleteService = (serviceid) => {
		this.props.doLoading();
		axios.post(serverUrl+'service_delete.php', {
            serviceid: serviceid
		}, 

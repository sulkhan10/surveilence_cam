...
class ListInvestmentCategory extends Component {
    constructor(props) {
        super(props);
		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'listinvestmentcategory');
		this.state = {
			tableData: [],
			filter: ''
        }
        ...
        this.tableColumns = [ {
            ...
            accessor: 'investmentcategoryname',
	...
	doRowEdit = (row) => {
        console.log(row);
		this.props.history.push('/panel/editinvestmentcategory/'+row.investmentcategoryid);
    }
    ...
    doRowDelete = (row) => {
		...
		confirmAlert({
		  ...
		  buttons: [
			{
				label: 'Yes',
				onClick: (investmentcategoryid) => {
					var investmentcategoryid = row.investmentcategoryid;
					console.log(investmentcategoryid);
					this.deleteInvestmentCategory(investmentcategoryid)					
			  }
			},
			{
			  label: 'No',
	...
	addNew = () => {
		this.props.history.push('/panel/inputinvestmentcategory');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'investmentcategory_list.php', {
	...
	deleteInvestmentCategory = (investmentcategoryid) => {
		this.props.doLoading();
		axios.post(serverUrl+'investmentcategory_delete.php', {
...
export default ListInvestmentCategory;
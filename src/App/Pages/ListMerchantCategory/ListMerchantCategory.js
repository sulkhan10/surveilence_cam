...
class ListMerchantCategory extends Component {
  constructor(props) {
    super(props);
    this.reactTable = React.createRef();
    this.globallang = getLanguage(activeLanguage, "global");
    this.language = getLanguage(activeLanguage, "listmerchantcategory");
  ...
  doRowEdit = (row) => {
    ...
    this.props.history.push(
      "/panel/editmerchantcategory/" + row.merchantcategoryid
    );
  };
  ...
  doRowDelete = (row) => {
    ...
    confirmAlert({
      ...
      buttons: [
        {
          label: "Yes",
          onClick: (merchantcategoryid) => {
            var merchantcategoryid = row.merchantcategoryid;
            // console.log(merchantcategoryid);
            this.deleteMerchantCategory(merchantcategoryid);
          },
        },
        {
          label: "No",
  ...
  addNew = () => {
    this.props.history.push("/panel/inputmerchantcategory");
  };
  ...
  deleteMerchantCategory = (merchantcategoryid) => {
    this.props.doLoading();
    axios
      .post(
        serverUrl + "merchantcategory_delete.php",
        {

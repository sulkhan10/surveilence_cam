...
class ListActivityCategory extends Component {
    constructor(props) {
		super(props);
	...
	doRowEdit = (row) => {
        console.log(row);
		this.props.history.push('/panel/editactivitycategory/'+row.activitycategoryid);
    }
    ...
    doRowDelete = (row) => {
		...
		confirmAlert({
		  ...
		  buttons: [
			{
				label: 'Yes',
				onClick: (activitycategoryid) => {
					var activitycategoryid = row.activitycategoryid;
					console.log(activitycategoryid);
					this.deleteActivityCategory(activitycategoryid)					
			  }
			},
			{
			  label: 'No',
	...
	addNew = () => {
		this.props.history.push('/panel/inputactivitycategory');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'activitycategory_list.php', {
	...
	deleteActivityCategory = (activitycategoryid) => {
		this.props.doLoading();
		axios.post(serverUrl+'activitycategory_delete.php', {
...
export default ListActivityCategory;
...
class EditFoodOrder extends Component {
  constructor(props) {
    ...
    this.statusPaymentHandleChecked = this.statusPaymentHandleChecked.bind(
      this
    );
  ...
  doNotifToMerchant = (order, merchant, contact) => {
    ...
    axios
      .post(serverUrl + "/whatsap_cs.php", params, {
        headers: {
          "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8",
        },
      })
    ...
    return (
      <div>
        ...
        <div className="form-button-container">
          <Button
            color="secondary"
            onClick={() => this.props.history.push("/panel/listoforder")}
          >

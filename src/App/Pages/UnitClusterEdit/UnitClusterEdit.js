...
export default class UnitClusterEdit extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount = () => {
    ...
    axios
      ...
      .then((response) => {
        this.props.doLoading();
        this.setState({ UnitID: response.data.record.UnitID });
        this.setState({ DebtorAcct: response.data.record.DebtorAcct });
        this.setState({ LotNo: response.data.record.LotNo });
        this.setState({ BisnisId: response.data.record.BisnisId });
        this.setState({ ClusterName: response.data.record.ClusterName });
        this.setState({ CompanyCode: response.data.record.CompanyCode });
        this.setState({ IsValid: response.data.record.IsValid });
      })
      .catch((error) => {
        this.props.doLoading();
        alert(error);

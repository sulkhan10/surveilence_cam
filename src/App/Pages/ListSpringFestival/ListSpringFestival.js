...
class ListSpringFestival extends Component {
    constructor(props) {
		super(props);
		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'listspringfestival');
        ...
        {
            Header: this.language.columncity,
			headerStyle: {fontWeight : 'bold'},
            accessor: 'city',
            style: { textAlign: "center"},
        },
        {
            Header: this.language.columncombo1,
			headerStyle: {fontWeight : 'bold'},
            accessor: 'combo1',
            style: { textAlign: "center"},
        },
        {
            Header: this.language.columncombo2,
			headerStyle: {fontWeight : 'bold'},
            accessor: 'combo2',
            style: { textAlign: "center"},
        },
        {
            Header: this.language.columncombo3,
			headerStyle: {fontWeight : 'bold'},
            accessor: 'combo3',
            style: { textAlign: "center"},
        },
        {
            Header: this.language.columncombo4,
			headerStyle: {fontWeight : 'bold'},
            accessor: 'combo4',
            style: { textAlign: "center"},
        },
        {
            Header: this.language.columncombo5,
			headerStyle: {fontWeight : 'bold'},
            accessor: 'combo5',
            style: { textAlign: "center"},
        },
	...
	doSearch = () => {
		...
		axios.post(serverUrl+'springfestival_list.php', {
    ...
    doExport=()=>{
        window.open(serverUrl+'springfestival_export.php?filter='+this.state.filter+'&startDate='+this.state.startDate.clone().startOf('day').format("YYYY-MM-DD HH:mm:ss")+'&endDate='+this.state.endDate.clone().endOf('day').format("YYYY-MM-DD HH:mm:ss"), '_blank');
    }
    ...
    getDataBydate =()=>{
        this.props.doLoading();
		axios.post(serverUrl+'springfestival_list_bydate.php', {
        ...
        return (
            <FormGroup>
                ...
                <div className="contentDate">
                    ...
                    &nbsp;&nbsp;
                    <Button color="success" size="sm" onClick={() => this.doSeacrhBydate()}><FontAwesomeIcon icon="random"/>&nbsp;{this.globallang.searchbydate}</Button>
                </div>
				<br></br>
				<br></br>
...
export default ListSpringFestival;
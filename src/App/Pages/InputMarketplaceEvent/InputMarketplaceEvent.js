...
class InputMarketplaceEvent extends Component {
    constructor(props) {
		super(props);
		this.globallang = getLanguage(activeLanguage, 'global');
		this.lang = getLanguage(activeLanguage, 'listcommodity');
		this.language = getLanguage(activeLanguage, 'inputmarketplaceevent');
		this.state = {
			marketplaceeventid: 0,
			latitude: -6.1772007,
...
export default InputMarketplaceEvent;
...
class ListProduct extends Component {
    constructor(props) {
		...
		this.language = getLanguage(activeLanguage, 'listproduct');
		this.state = {
			tableData: [],
			filter:'',
	...
	doRowEdit = (row) => {
		this.props.history.push('/panel/editproduct/'+row.productid);
    }
	...
	addNew = () => {
		this.props.history.push('/panel/inputproduct');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'product_list.php', {
	...
	deleteProduct = (productid) => {
		this.props.doLoading();
		axios.post(serverUrl+'product_delete.php', {
            productid: productid
		}, 

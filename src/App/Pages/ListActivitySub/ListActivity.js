...
class ListActivity extends Component {
    constructor(props) {
		...
		this.language = getLanguage(activeLanguage, 'listactivity');
	...
	doRowEdit = (row) => {
		this.props.history.push('/panel/editactivity/'+row.activityid);
    }
	...
	addNew = () => {
		this.props.history.push('/panel/inputactivity');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'activity_list.php', {
	...
	deleteActivity = (activityid) => {
		this.props.doLoading();
		axios.post(serverUrl+'activity_delete.php', {

...
class EditNewsWFH extends Component {
    constructor(props) {
		super(props);
		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'editwfh');
		this.state = {
	...
	componentDidMount = () =>{
		...
		axios.post(serverUrl+'news_wfh_get_by_id.php', {

...
class ListServiceCenterCategory extends Component {
    constructor(props) {
		super(props);
		this.reactTable = React.createRef();
		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'listservicecentercategory');
	...
	doRowEdit = (row) => {
        console.log(row);
		this.props.history.push('/panel/editservicecentercategory/'+row.servicecentercategoryid);
    }
    ...
    doRowDelete = (row) => {
		...
		confirmAlert({
		  ...
		  buttons: [
			{
				label: 'Yes',
				onClick: (servicecentercategoryid) => {
					var servicecentercategoryid = row.servicecentercategoryid;
					console.log(servicecentercategoryid);
					this.deleteServiceCenterCategory(servicecentercategoryid)					
			  }
			},
			{
			  label: 'No',
	...
	addNew = () => {
		this.props.history.push('/panel/inputservicecentercategory');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'servicecentercategory_list.php', {
	...
	deleteServiceCenterCategory = (servicecentercategoryid) => {
		this.props.doLoading();
		axios.post(serverUrl+'servicecentercategory_delete.php', {
            servicecentercategoryid: servicecentercategoryid
		}, 
...
export default ListServiceCenterCategory;
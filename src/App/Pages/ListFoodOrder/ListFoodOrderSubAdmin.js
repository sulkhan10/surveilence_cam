...
class ListFoodOrder extends Component {
  ...
  doRowEdit = (row) => {
    this.props.history.push("/panel/editorderlist/" + row.foodorderid);
  };
  ...
  doSearch = () => {
    ...
    axios
      .post(
        serverUrl + "foodorder_merchant.php",
        {
  ...
  selectCommunity = (dataCommunity, merchantId) => {
    axios
      ...
      .then((response) => {
        ...
        this.LoadDataOrder(getCommunityIdGlobal[0].communityCode, merchantId);
      })
      .catch((error) => {
        console.log(error);
        alert(error);
  ...
  LoadDataOrder = (communityCode, merchantId) => {
    this.props.doLoading();
    axios
      .post(
      ...
      .then((response) => {
        ...
        const resultCommodity = result.filter(
          (elm) => elm.merchantid === merchantId
        );
        this.setState({ tableData: resultCommodity });
      })
      .catch((error) => {
        this.props.doLoading();
        console.log(error);

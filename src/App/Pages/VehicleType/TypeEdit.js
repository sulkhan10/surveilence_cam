...
class EditVehicleType extends Component {
  ...
  componentDidMount = () => {
    ...
    axios
      .post(
        serverUrl + "vehicle_type_get_by_id.php",
        {
      ...
      .then((response) => {
        this.props.doLoading();
        this.setState({ vehicleId: response.data.record.vehicleId });
        this.setState({ vehicleName: response.data.record.vehicleName });
      })
      .catch((error) => {
        this.props.doLoading();
        console.log(error);
  ...
  checkData = () => {
    ...
    if (vehicleName === "") {
      this.setState({
        messageError: "Enter vehicle type.",
  ...
  onSubmit = () => {
    ...
    axios
      .post(
        serverUrl + "vehicle_type_insert_update.php",
        {
          vehicleId: this.state.vehicleId,
      ...
      .then((response) => {
        ...
        // this.props.history.push("/panel/vehicletype");
      })
      .catch((error) => {
        this.props.doLoading();
        console.log(error);
  ...
  renderSuccess = () => {
    if (this.state.openSuccess === true) {
      setTimeout(() => this.props.history.push("/panel/vehicletype"), 1000);
            ...
            <Alert
              ...
              action={
                <IconButton
                  ...
                  color="inherit"
                  size="small"
                  onClick={() => this.props.history.push("/panel/vehicletype")}
                >

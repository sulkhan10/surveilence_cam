...
class TypeVehicleList extends Component {
  constructor(props) {
    super(props);
  ...
  doRowEdit = (row) => {
    this.props.history.push("/panel/editvehicletype/" + row.vehicleId);
  };

  doRowDelete = (row) => {
    confirmAlert({
      message: "Do you want to delete " + row.vehicleName + "?",
      buttons: [
        {
          label: "Yes",
          onClick: (vehicleId) => {
  ...
  addNew = () => {
    this.props.history.push("/panel/inputvehicletype");
  };
  ...
  deleteLocation = (vehicleId) => {
    this.props.doLoading();
    axios
      .post(
        serverUrl + "vehicle_type_delete.php",
        {
          vehicleId: vehicleId,
        },
        {

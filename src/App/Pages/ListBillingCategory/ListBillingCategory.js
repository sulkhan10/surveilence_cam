...
class ListBillingCategory extends Component {
    constructor(props) {
		super(props);
		this.reactTable = React.createRef();
		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'listbillingcategory');
	...
	doRowEdit = (row) => {
        console.log(row);
		this.props.history.push('/panel/editbillingcategory/'+row.billingcategoryid);
    }
    ...
    doRowDelete = (row) => {
		...
		confirmAlert({
		  ...
		  buttons: [
			{
				label: 'Yes',
				onClick: (billingcategoryid) => {
					var billingcategoryid = row.billingcategoryid;
					console.log(billingcategoryid);
					this.deleteBillingCategory(billingcategoryid)					
			  }
			},
			{
			  label: 'No',
	...
	addNew = () => {
		this.props.history.push('/panel/inputbillingcategory');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'billingcategory_list.php', {
	...
	deleteBillingCategory = (billingcategoryid) => {
		this.props.doLoading();
		axios.post(serverUrl+'billingcategory_delete.php', {
...
export default ListBillingCategory;
...
class EditNewsCategory extends Component {
  constructor(props) {
    ...
    this.language = getLanguage(activeLanguage, "editnewscategory");
    this.state = {
      newscategoryid: props.match.params.newscategoryid,
      newscategoryname: "",
      messageError: "",
  ...
  checkData = () => {
    ...
    if (newscategoryname === "") {
      this.setState({
        messageError: "Enter news category name.",
  ...
  componentDidMount = () => {
    ...
    axios
      .post(
        serverUrl + "newscategory_get_by_id.php",
        {
      ...
      .then((response) => {
        ...
        this.setState({ newscategoryid: response.data.record.newscategoryid });
        this.setState({
          newscategoryname: response.data.record.newscategoryname,
        });
      })
      .catch((error) => {
        this.props.doLoading();
  ...
  onSubmit = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        // this.props.history.push('/panel/listnewscategory');
      })
      .catch((error) => {
        this.props.doLoading();
        console.log(error);
      ...
      <div>
        <div className="page-header">
          <ButtonUI
            ...
            onClick={() => this.props.history.push("/panel/listnewscategory")}
          >
            <Typography
              variant="button"
              style={{
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={10}>
                <Input
                  ...
                  id="newscategoryname"
                  value={this.state.newscategoryname}
                  placeholder="News category name"
                  onChange={(event) =>
                    this.setState({ newscategoryname: event.target.value })
                  }
                />
              </Grid>
            </Grid>

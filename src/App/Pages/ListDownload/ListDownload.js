...
class ListDownload extends Component {
    constructor(props) {
		super(props);
		
		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'listdownload');
		...
		{
            Header: 'Download Picture',
			headerStyle: {fontWeight : 'bold'},
            accessor: 'downloadpic',
            style: { textAlign: "center"}
        },*/ 		
		{
	...
	doRowEdit = (row) => {
		this.props.history.push('/panel/editdownload/'+row.downloadid);
    }
	...
	addNew = () => {
		this.props.history.push('/panel/inputdownload');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'download_list.php', {
	...
	deleteDownload = (downloadid) => {
		this.props.doLoading();
		axios.post(serverUrl+'download_delete.php', {

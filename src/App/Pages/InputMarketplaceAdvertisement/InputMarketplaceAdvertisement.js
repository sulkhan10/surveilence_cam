...
class InputMarketplaceAdvertisement extends Component {
  constructor(props) {
    super(props);
  ...
  checkData = () => {
    ...
    if (name === "") {
      this.setState({
        messageError: "Enter name Advertisement.",
        setOpenValidation: true,
      });
    } else if (bannerpic.length === 0) {
      this.setState({
        messageError: "Enter banner picture.",
        setOpenValidation: true,
      });
    } else {
      this.onSubmit();
...
export default InputMarketplaceAdvertisement;

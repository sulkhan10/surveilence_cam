...
class InputCompany extends Component {
    constructor(props) {
		...
		this.language = getLanguage(activeLanguage, 'inputcompany');
	...
	changeCompanyCategory = (companycategoryid)=>{
		console.log(this.state.companycategoryid);
                ...
                <div className="box-container">
					<table>
						<tr>
                            ...
                            <td><Input type="text" name="companyname" id="companyname" placeholder={this.language.fieldname} value={this.state.companyname} onChange = {(event) => this.setState({ companyname : event.target.value }) }/></td>
                        </tr>
						<tr>
						&nbsp;
						</tr>

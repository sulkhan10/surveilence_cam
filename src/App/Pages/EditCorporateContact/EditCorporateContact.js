...
class EditCorporateContact extends Component {
    constructor(props) {
		super(props);
		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'editcorporatecontact');
		this.state = {
	...
	componentDidMount = (communityShow) =>{
		...
		axios.post(serverUrl+'corporatecontact_get_by_id.php', {
            id: this.state.id,
		}, 
...
export default EditCorporateContact;
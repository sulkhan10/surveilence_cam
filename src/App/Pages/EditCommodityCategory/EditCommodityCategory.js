...
class EditCommodityCategory extends Component {
  constructor(props) {
    super(props);
    this.globallang = getLanguage(activeLanguage, "global");
    this.language = getLanguage(activeLanguage, "editcommoditycategory");
    this.state = {
      commoditycategoryid: props.match.params.commoditycategoryid,
  ...
  componentDidMount = () => {
    ...
    axios
      .post(
        serverUrl + "commoditycategory_get_by_id.php",
        {
      ...
      .then((response) => {
        ...
        this.setState({
          commoditycategoryname: response.data.record.commoditycategoryname,
        });
      })
      .catch((error) => {
        this.props.doLoading();
...
export default EditCommodityCategory;

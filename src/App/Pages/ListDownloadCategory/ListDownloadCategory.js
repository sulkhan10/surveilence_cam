...
class ListDownloadCategory extends Component {
    constructor(props) {
		super(props);
		this.globallang = getLanguage(activeLanguage, 'global');
		this.language = getLanguage(activeLanguage, 'listdownloadcategory');
	...
	doRowEdit = (row) => {
        console.log(row);
		this.props.history.push('/panel/editdownloadcategory/'+row.downloadcategoryid);
    }
    ...
    doRowDelete = (row) => {
		...
		confirmAlert({
		  ...
		  buttons: [
			{
				label: 'Yes',
				onClick: (downloadcategoryid) => {
					var downloadcategoryid = row.downloadcategoryid;
					console.log(downloadcategoryid);
					this.deleteDownloadCategory(downloadcategoryid)					
			  }
			},
			{
			  label: 'No',
	...
	addNew = () => {
		this.props.history.push('/panel/inputdownloadcategory');
	}
	
	doSearch = () => {
		this.props.doLoading();
		axios.post(serverUrl+'downloadcategory_list.php', {
	...
	deleteDownloadCategory = (downloadcategoryid) => {
		this.props.doLoading();
		axios.post(serverUrl+'downloadcategory_delete.php', {
...
export default ListDownloadCategory;
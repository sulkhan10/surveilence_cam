...
class EditTag extends Component {
  constructor(props) {
    ...
    this.language = getLanguage(activeLanguage, "edittag");
    this.state = {
  ...
  componentDidMount = () => {
    ...
    axios
      ...
      .then((response) => {
        this.props.doLoading();
        this.setState({ tagid: response.data.record.tagid });
        this.setState({ tagname: response.data.record.tagname });
      })
      .catch((error) => {
        this.props.doLoading();
        console.log(error);

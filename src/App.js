...
const client2 = new W3CWebSocket("ws://127.0.0.1:4001");
...
class LiveViewPage extends Component {
      ...
      .then((response) => {
        ...
        if (response.data.status == 200) {
          if (response.data.data.records.length > 0) {
            this.setState({
              viewListData: response.data.data.records,
              listViewCamera: response.data.data.records,
            });
          }
        }
        this.sendRequest("startLiveView", {
          listViewCameraData: JSON.stringify(response.data.data.records),
        });
        this.sendRequest2("startLiveView", {
          listViewCameraData: JSON.stringify(response.data.data.records),
        });
      })
      .catch((error) => {
  ...
  componentDidMount = async () => {
    ...
    client.onopen = () => {
      ...
      console.log(this.state.listViewCamera, "list view camera");
      console.log(this.state.viewListData, "view list data");

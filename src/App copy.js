...
import { apiGroupList, apiViewList } from "./App/Service/api";
...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      // baseUrl: "http://192.168.2.200:4000/",
  ...
  getViewList = () => {
    ...
    //     {
    //         "deviceName": "Camera 1",
    //         "urlRTSP": "rtsp://SIMCAM:EWVN1D@192.168.1.187/live",
    //         "outputFileFormat": "mp4",
    //         "videoCodec": "h264",
    //         "videoBitRate": "500k",
    //         "frameRate": 30,
  ...
  componentDidMount = () => {
    ...
    client.onopen = async () => {
      ...
      await this.sendRequest("startLiveView", 
      {
          listViewCameraData: this.state.listViewCamera,
        }
        );
    };
  ...
  //         needPlayButton: true,
  //       });
  //       console.log("camera Player",cameraplayer);
  ...
  renderStream2 = (obj, index) => {
    console.log("render stream 2", obj);
